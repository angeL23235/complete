...
<body>
    ...
    <div class="tabla_m text-center">
        ...
        if ($_SESSION['rl'] == 2) {
            ...
            $result2 = mysqli_query($con, "SELECT s.*, u.email FROM serviciosc s JOIN usuario u ON s.fk_user = u.numero_documento WHERE u.id_rol = 2 AND s.tipo_servs = 'alquiler_au'") or die("Error en la consulta");
        }
                                ...
                                <form method="post" action="dashboard.php?mod=autos" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-success"
                                            name="btn_update"><?php echo $translations['update_service']; ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <form method="post" action="dashboard.php?mod=autos">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-danger"
                                            name="btn_delete"><?php echo $translations['remove']; ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
