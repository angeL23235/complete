            ...
            <table class="table">
                ...
                <tbody>
                   ...
                   if ($_SESSION['rl'] == 2) {
                       ...
                       $result2 = mysqli_query($con, "SELECT * FROM serviciosc s JOIN usuario u ON s.fk_user = u.numero_documento WHERE u.id_rol = 2 AND s.tipo_servs = 'cocina'") or die("Error en la consulta");
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-center" id="editModalLabel-<?php echo $id_serv; ?>">
                                        <?php echo $translations['edit_service']; ?></h5>
                                    ...
                                    <form method="post" action="dashboard.php?mod=cocina" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-success"
                                                name="btn_actualizar"><?php echo $translations['update_service']; ?></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-center" id="deleteModalLabel<?php echo $id_serv; ?>">
                                        <?php echo $translations['delete']; ?></h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form method="post" action="dashboard.php?mod=cocina">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-danger"
                                                name="btn_eliminar"><?php echo $translations['remove']; ?></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
